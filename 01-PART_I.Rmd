...
So far, you learned the different data structure you can use within Google Earth Engine. However, if you want to do any computation with the data stored in these different types of structure, you will have to use an Earth Engine container. The `ee` package is used for formulating requests to Earth Engine. In other words, `ee` allows you to request Earth Engine servers to perform a certain computation to an varible or object.
