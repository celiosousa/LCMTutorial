...
Export this new classification to you assets. Next, [open a new code editor page](https://code.earthengine.google.com/){target="_blank"} and add the classification exports to this script by clicking the *__Import into script__* button (blue arrow) for both classification assets in the Assets tab as shown in the figure 3.12:
